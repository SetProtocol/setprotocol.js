...
describe('WhitelistWrapper', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    whitelistWrapper = new wrappers_1.WhitelistWrapper(web3);
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            initializedWhitelistAddresses = [constants_1.DEFAULT_ACCOUNT];
                            return [4 /*yield*/, helpers_1.deployWhitelistContract(initializedWhitelistAddresses, web3)];
                        case 1:
...
//# sourceMappingURL=WhitelistWrapper.spec.js.map
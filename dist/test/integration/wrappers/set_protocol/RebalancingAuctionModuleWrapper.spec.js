...
describe('RebalancingAuctionModuleWrapper', function () {
    ...
    describe('bidPlacedEvent', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, rebalancingAuctionModuleWrapper.bidPlacedEvent(subjectFromBlock, subjectToBlock, subjectRebalancingSetToken)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        }
        var rebalancingSetToken, currentSetToken, nextSetToken, earlyTxnHash, earlyBlockNumber, bidQuantity, allowPartialFill, bidderAccount, bid1TxnHash, bid2TxnHash, subjectFromBlock, subjectToBlock, subjectRebalancingSetToken;
        var _this = this;
        return __generator(this, function (_a) {
            beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                var setTokens, proposalPeriod, managerAddress, rebalancingSetQuantityToIssue, _a, proposalComponentOne, proposalComponentTwo, priceCurve, auctionPriceCurveAddress, setAuctionTimeToPivot, setAuctionStartPrice, setAuctionPivotPrice, rebalancingSetToken2, earlyTransaction, lastBidTransaction, bidBlockNumber;
                return __generator(this, function (_b) {
                    switch (_b.label) {
            ...
            test('retrieves the bid event properties', function () { return __awaiter(_this, void 0, void 0, function () {
                var events, returnValues, bidder, executionQuantity, returnedRebalancingSetToken;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, subject()];
                        case 1:
                            ...
                            bidder = returnValues.bidder, executionQuantity = returnValues.executionQuantity;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 9:
                            ...
                            return [4 /*yield*/, helpers_1.transitionToDrawdownAsync(web3, rebalancingSetToken, managerAddress, nextSetToken.address, auctionPriceCurveAddress, rebalanceAuctionModule, setBidAmount, setAuctionTimeToPivot, setAuctionStartPrice, setAuctionPivotPrice)];
                        case 10:
                            _b.sent();

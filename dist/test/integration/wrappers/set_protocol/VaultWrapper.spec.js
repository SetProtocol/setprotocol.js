...
describe('VaultWrapper', function () {
    var transferProxy;
    var vault;
    var core;
    var coreWrapper;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    vaultWrapper = new wrappers_1.VaultWrapper(web3, vault.address);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    describe('getBalanceInVault', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, vaultWrapper.getBalanceInVault(subjectTokenAddress, subjectTokenOwner)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        }
        var token, vaultBalance, subjectTokenAddress, subjectTokenOwner;
        var _this = this;
        return __generator(this, function (_a) {
            beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.sent();
                            vaultBalance = new util_1.BigNumber(100);
                            return [4 /*yield*/, coreWrapper.deposit(token.address, vaultBalance, { from: constants_1.DEFAULT_ACCOUNT })];
                        case 3:
                            _a.sent();
            ...
            test('gets owner balance', function () { return __awaiter(_this, void 0, void 0, function () {
                var vaultTokenBalance;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, subject()];
                        case 1:
                            vaultTokenBalance = _a.sent();
...
//# sourceMappingURL=VaultWrapper.spec.js.map
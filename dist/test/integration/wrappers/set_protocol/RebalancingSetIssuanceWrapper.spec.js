...
describe('RebalancingSetIssuanceModuleWrapper', function () {
    var transferProxy;
    var vault;
    var core;
    var setTokenFactory;
    ...
    var wethMock;
    var rebalancingSetIssuanceModuleWrapper;
    var functionCaller = accounts_1.ACCOUNTS[1].address;
    beforeAll(function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    _b.sent();
                    rebalancingSetIssuanceModuleWrapper = new wrappers_1.RebalancingSetIssuanceModuleWrapper(web3, rebalancingSetIssuanceModule.address);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    describe('#issueRebalancingSet', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, rebalancingSetIssuanceModuleWrapper.issueRebalancingSet(subjectRebalancingSetAddress, subjectRebalancingSetQuantity, subjectKeepChangeInVault, {
                            from: subjectCaller,
    ...
    describe('#issueRebalancingSetWrappingEther', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, rebalancingSetIssuanceModuleWrapper.issueRebalancingSetWrappingEther(subjectRebalancingSetAddress, subjectRebalancingSetQuantity, subjectKeepChangeInVault, {
                            from: subjectCaller,
                            gas: constants_1.DEFAULT_GAS_LIMIT,
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            componentAddresses = [baseSetWethComponent.address, baseSetComponent.address];
                            baseSetComponentUnit = util_1.ether(1);
                            componentUnits = [baseSetComponentUnit, baseSetComponentUnit];
                            baseSetNaturalUnit = util_1.ether(1);
                            return [4 /*yield*/, helpers_1.deploySetTokenAsync(web3, core, setTokenFactory.address, componentAddresses, componentUnits, baseSetNaturalUnit)];
    ...
    describe('#redeemRebalancingSet', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, rebalancingSetIssuanceModuleWrapper.redeemRebalancingSet(subjectRebalancingSetAddress, subjectRebalancingSetQuantity, subjectKeepChangeInVault, {
                            from: subjectCaller,
                            gas: constants_1.DEFAULT_GAS_LIMIT,
                        })];
                });
    ...
    describe('#redeemRebalancingSetUnwrappingEther', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, rebalancingSetIssuanceModuleWrapper.redeemRebalancingSetUnwrappingEther(subjectRebalancingSetAddress, subjectRebalancingSetQuantity, subjectKeepChangeInVault, {
                            from: subjectCaller,
                            gas: constants_1.DEFAULT_GAS_LIMIT,
                        })];
                });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            ...
                            return [4 /*yield*/, wethMock.deposit.sendTransactionAsync({ from: accounts_1.DEFAULT_ACCOUNT, gas: constants_1.DEFAULT_GAS_LIMIT, value: wethRequiredToMintSet.toString() })];
                        case 6:
                            _a.sent();
                            return [4 /*yield*/, core.issue.sendTransactionAsync(baseSetToken.address, baseSetIssueQuantity, { from: accounts_1.DEFAULT_ACCOUNT, gas: constants_1.DEFAULT_GAS_LIMIT })];
                        case 7:
...
//# sourceMappingURL=RebalancingSetIssuanceWrapper.spec.js.map
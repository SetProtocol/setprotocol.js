  ...
  lastRebalanceTimestamp, proposalPeriod, rebalanceInterval', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                var manager, rebalanceState, currentSet, unitShares, naturalUnit, lastRebalanceTimestamp, proposalPeriod, rebalanceInterval;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            unitShares = _a.sent();
                            return [4 /*yield*/, rebalancingSetTokenWrapper.naturalUnit(subjectRebalancingSetTokenAddress)];
                        case 5:
                            naturalUnit = _a.sent();
        ...
        return __generator(this, function (_a) {
            ...
            test('it fetches the set token properties correctly', function () { return __awaiter(_this, void 0, void 0, function () {
                var _a, manager, rebalanceState, currentSet, unitShares, naturalUnit, lastRebalanceTimestamp, proposalPeriod, rebalanceInterval;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, subject()];
                        case 1:
                            _a = _b.sent(), manager = _a.manager, rebalanceState = _a.rebalanceState, currentSet = _a.currentSet, unitShares = _a.unitShares, naturalUnit = _a.naturalUnit, lastRebalanceTimestamp = _a.lastRebalanceTimestamp, proposalPeriod = _a.proposalPeriod, rebalanceInterval = _a.rebalanceInterval;
                            ...
                            expect(naturalUnit).to.be.bignumber.equal(constants_1.DEFAULT_REBALANCING_NATURAL_UNIT);
  ...
  combinedTokenArray, combinedCurrentUnits, combinedNextSetUnits', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    describe('settleRebalance', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            test('it fetches the set token properties correctly', function () { return __awaiter(_this, void 0, void 0, function () {
                var expectedUnitShares, lastBlock, auctionEndTimestamp, returnedRebalanceState, returnedCurrentSet, returnedUnitShares, returnedNaturalUnit, returnedLastRebalanceTimestamp;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 8:
                            ...
                            expect(returnedNaturalUnit).to.be.bignumber.equal(constants_1.DEFAULT_REBALANCING_NATURAL_UNIT);

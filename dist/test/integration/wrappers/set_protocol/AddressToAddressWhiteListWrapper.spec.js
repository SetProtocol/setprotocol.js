...
describe('AddressToAddressWhiteListWrapper', function () {
    var whitelistWrapper;
    var whitelistInstance;
    var initialKeyAddresses;
    var initialValueAddresses;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    whitelistWrapper = new wrappers_1.AddressToAddressWhiteListWrapper(web3);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    describe('validAddresses', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, whitelistWrapper.validAddresses(subjectWhitelistContract)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        }
        var subjectWhitelistContract;
        var _this = this;
        return __generator(this, function (_a) {
            beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
    ...
    describe('getValues', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, whitelistWrapper.getValues(subjectWhitelistContract, subjectKeyValues)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        }
        var subjectWhitelistContract, subjectKeyValues;
        var _this = this;
        return __generator(this, function (_a) {
            beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
...
//# sourceMappingURL=AddressToAddressWhiteListWrapper.spec.js.map
...
describe('ETHDAIRebalancingManagerWrapper', function () {
    var core;
    var transferProxy;
    var factory;
    var rebalancingFactory;
    var constantAuctionPriceCurve;
    var ethDaiRebalancingManager;
    var ethMedianizer;
    var wrappedETH;
    var dai;
    var whitelist;
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 5:
                    _b = _c.sent(), wrappedETH = _b[0], dai = _b[1];
                    return [4 /*yield*/, helpers_1.approveForTransferAsync([wrappedETH, dai], transferProxy.address)];
                case 6:
                    _c.sent();
                ...
                case 11:
                    ethDaiRebalancingManager = _c.sent();
    ...
    describe('core', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ethDaiManagerWrapper.core(subjectManagerAddress)];
    ...
    describe('ethPriceFeed', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ethDaiManagerWrapper.ethPriceFeed(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('ethAddress', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ethDaiManagerWrapper.ethAddress(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('daiAddress', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ethDaiManagerWrapper.daiAddress(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('setTokenFactory', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ethDaiManagerWrapper.setTokenFactory(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('ethMultiplier', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ethDaiManagerWrapper.ethMultiplier(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('daiMultiplier', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ethDaiManagerWrapper.daiMultiplier(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('maximumLowerThreshold', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ethDaiManagerWrapper.maximumLowerThreshold(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('minimumUpperThreshold', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ethDaiManagerWrapper.minimumUpperThreshold(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('auctionLibrary', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ethDaiManagerWrapper.auctionLibrary(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('auctionTimeToPivot', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ethDaiManagerWrapper.auctionTimeToPivot(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, ethDaiManagerWrapper.propose(subjectManagerAddress, subjectRebalancingSetToken, { from: subjectCaller })];
                        case 2: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        }
        var rebalancingSetToken, proposalPeriod, ethPrice, daiUnit, initialAllocationToken, timeFastForward, subjectRebalancingSetToken, subjectManagerAddress, subjectCaller;
        var _this = this;
        return __generator(this, function (_a) {
            beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ethPrice = new util_1.BigNumber(350 * Math.pow(10, 18));
                    daiUnit = new util_1.BigNumber(300 * 100);
                    return [2 /*return*/];
                });
            }); });
            beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
...
//# sourceMappingURL=ETHDAIRebalancingManagerWrapper.spec.js.map
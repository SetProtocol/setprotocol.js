...
describe('PriceFeedWrapper', function () {
    var medianizerWrapper;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    medianizerWrapper = new wrappers_1.MedianizerWrapper(web3);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    describe('read', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, medianizerWrapper.read(subjectMedianizerAddress)];
        ...
        return __generator(this, function (_a) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, helpers_1.addPriceFeedOwnerToMedianizer(btcMedianizer, constants_1.DEFAULT_ACCOUNT)];
                        case 2:
                            _a.sent();
            ...
            test('gets the correct price', function () { return __awaiter(_this, void 0, void 0, function () {
                var price, priceBuffer, expectedValue;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, subject()];
                        case 1:
                            price = _a.sent();
                            priceBuffer = SetUtils.paddedBufferForBigNumber(btcPrice);
                            expectedValue = SetTestUtils.bufferArrayToHex([priceBuffer]);
...
//# sourceMappingURL=MedianizerWrapper.spec.js.map
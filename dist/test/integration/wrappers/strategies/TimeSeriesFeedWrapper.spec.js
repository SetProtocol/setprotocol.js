...
describe('TimeSeriesFeedWrapper', function () {
    var dailyPriceFeed;
    var timeSeriesFeedWrapper;
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        var medianizer, dataSourceAddress;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _a.sent();
                    dataSourceAddress = medianizer.address;
                    return [4 /*yield*/, helpers_1.deployTimeSeriesFeedAsync(web3, dataSourceAddress, seededPriceFeedPrices, priceFeedUpdateFrequency)];
                case 5:
                    dailyPriceFeed = _a.sent();
                    timeSeriesFeedWrapper = new wrappers_1.TimeSeriesFeedWrapper(web3);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    describe('nextEarliestUpdate', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, timeSeriesFeedWrapper.nextEarliestUpdate(subjectPriceFeedAddress)];
        ...
        return __generator(this, function (_a) {
            ...
            test('fetches the correct timestamp', function () { return __awaiter(_this, void 0, void 0, function () {
                var nextAvailableUpdate, blockNumber, timestamp, expectedTimestamp;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, subject()];
                        case 1:
                            nextAvailableUpdate = _a.sent();
    ...
    describe('getTimeSeriesFeedState', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, timeSeriesFeedWrapper.getTimeSeriesFeedState(subjectTimeSeriesFeedAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        }
        var subjectTimeSeriesFeedAddress;
        var _this = this;
        return __generator(this, function (_a) {
            beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
...
//# sourceMappingURL=TimeSeriesFeedWrapper.spec.js.map
...
describe('BTCETHRebalancingManagerWrapper', function () {
    var core;
    var transferProxy;
    var factory;
    var rebalancingFactory;
    var constantAuctionPriceCurve;
    var btcethRebalancingManager;
    var btcMedianizer;
    var ethMedianizer;
    var wrappedBTC;
    var wrappedETH;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 11:
                    ...
                    return [4 /*yield*/, helpers_1.deployBtcEthManagerContractAsync(web3, core.address, btcMedianizer.address, ethMedianizer.address, wrappedBTC.address, wrappedETH.address, factory.address, constantAuctionPriceCurve.address, auctionTimeToPivot, [btcMultiplier, ethMultiplier], [new util_1.BigNumber(48), new util_1.BigNumber(52)])];
                case 12:
                    btcethRebalancingManager = _c.sent();
    ...
    describe('core', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, btcEthManagerWrapper.core(subjectManagerAddress)];
    ...
    describe('btcPriceFeed', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, btcEthManagerWrapper.btcPriceFeed(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('ethPriceFeed', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, btcEthManagerWrapper.ethPriceFeed(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        ...
        return __generator(this, function (_a) {
            ...
            test('gets the correct ethPriceFeed', function () { return __awaiter(_this, void 0, void 0, function () {
                var address;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, subject()];
    ...
    describe('btcAddress', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, btcEthManagerWrapper.btcAddress(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('ethAddress', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, btcEthManagerWrapper.ethAddress(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('setTokenFactory', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, btcEthManagerWrapper.setTokenFactory(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('btcMultiplier', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, btcEthManagerWrapper.btcMultiplier(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('ethMultiplier', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, btcEthManagerWrapper.ethMultiplier(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        ...
        return __generator(this, function (_a) {
            ...
            test('gets the correct ethMultiplier', function () { return __awaiter(_this, void 0, void 0, function () {
                var address;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, subject()];
    ...
    describe('auctionLibrary', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, btcEthManagerWrapper.auctionLibrary(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    describe('auctionTimeToPivot', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, btcEthManagerWrapper.auctionTimeToPivot(subjectManagerAddress)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, btcEthManagerWrapper.propose(subjectManagerAddress, subjectRebalancingSetToken, { from: subjectCaller })];
                        case 2: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        }
        var rebalancingSetToken, proposalPeriod, btcPrice, ethPrice, ethUnit, initialAllocationToken, timeFastForward, subjectRebalancingSetToken, subjectManagerAddress, subjectCaller;
        var _this = this;
        return __generator(this, function (_a) {
...
//# sourceMappingURL=BTCETHRebalancingManagerWrapper.spec.js.map
 ...
 *
 */
var HistoricalPriceFeedWrapper = /** @class */ (function () {
    function HistoricalPriceFeedWrapper(web3) {
        this.web3 = web3;
     ...
     */
    HistoricalPriceFeedWrapper.prototype.read = function (historicalPriceFeedAddress, dataDays) {
        return __awaiter(this, void 0, void 0, function () {
            var historicalPriceFeed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.loadHistoricalPriceFeedContract(historicalPriceFeedAddress)];
                    case 1:
                        historicalPriceFeed = _a.sent();
                        return [4 /*yield*/, historicalPriceFeed.read.callAsync(dataDays)];
     ...
     * @return                               Unix time
     */
    HistoricalPriceFeedWrapper.prototype.lastUpdatedAt = function (historicalPriceFeedAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var historicalPriceFeed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        historicalPriceFeed = _a.sent();
                        return [4 /*yield*/, historicalPriceFeed.lastUpdatedAt.callAsync()];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     */
    HistoricalPriceFeedWrapper.prototype.poke = function (historicalPriceFeedAddress, txOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var historicalPriceFeed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        historicalPriceFeed = _a.sent();
                        return [4 /*yield*/, historicalPriceFeed.poke.sendTransactionAsync(txOpts)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    return HistoricalPriceFeedWrapper;
}());
exports.HistoricalPriceFeedWrapper = HistoricalPriceFeedWrapper;
//# sourceMappingURL=HistoricalPriceFeedWrapper.js.map
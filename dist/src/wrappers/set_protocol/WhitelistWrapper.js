 ...
 *
 */
var WhitelistWrapper = /** @class */ (function () {
    function WhitelistWrapper(web3) {
        this.web3 = web3;
     ...
     */
    WhitelistWrapper.prototype.validAddresses = function (whitelistContract) {
        return __awaiter(this, void 0, void 0, function () {
            var whitelistInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.loadWhitelistAsync(whitelistContract)];
                    case 1:
...
exports.WhitelistWrapper = WhitelistWrapper;
//# sourceMappingURL=WhitelistWrapper.js.map
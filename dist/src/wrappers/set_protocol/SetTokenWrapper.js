 ...
 *
 */
var SetTokenWrapper = /** @class */ (function () {
    function SetTokenWrapper(web3) {
        this.web3 = web3;
     ...
     */
    SetTokenWrapper.prototype.factory = function (setAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var setTokenInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.loadSetTokenAsync(setAddress)];
                    case 1:
                        setTokenInstance = _a.sent();
                        return [4 /*yield*/, setTokenInstance.factory.callAsync()];
     ...
     */
    SetTokenWrapper.prototype.getComponents = function (setAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var setTokenInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    SetTokenWrapper.prototype.naturalUnit = function (setAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var setTokenInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    SetTokenWrapper.prototype.getUnits = function (setAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var setTokenInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return SetTokenWrapper;
}());
exports.SetTokenWrapper = SetTokenWrapper;
//# sourceMappingURL=SetTokenWrapper.js.map
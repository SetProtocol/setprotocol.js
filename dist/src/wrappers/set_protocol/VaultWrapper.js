 ...
 *
 */
var VaultWrapper = /** @class */ (function () {
    function VaultWrapper(web3, vaultAddress) {
        this.web3 = web3;
     ...
     */
    VaultWrapper.prototype.getBalanceInVault = function (tokenAddress, ownerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var vaultInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.loadVaultAsync(this.vaultAddress)];
                    case 1:
                        vaultInstance = _a.sent();
                        return [4 /*yield*/, vaultInstance.getOwnerBalance.callAsync(tokenAddress, ownerAddress)];
...
exports.VaultWrapper = VaultWrapper;
//# sourceMappingURL=VaultWrapper.js.map
 ...
 *
 */
var RebalancingSetEthBidderWrapper = /** @class */ (function () {
    function RebalancingSetEthBidderWrapper(web3, rebalancingSetEthBidderAddress) {
        this.web3 = web3;
     ...
     */
    RebalancingSetEthBidderWrapper.prototype.bidPlacedWithEthEvent = function (fromBlock, toBlock, rebalancingSetToken) {
        if (toBlock === void 0) { toBlock = 'latest'; }
        return __awaiter(this, void 0, void 0, function () {
            var rebalancingSetEthBidderInstance, filter, events;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        rebalancingSetEthBidderInstance = new this.web3.eth.Contract(set_protocol_contracts_1.RebalancingSetEthBidder.abi, this.rebalancingSetEthBidderAddress);
                        filter = {};
                        if (rebalancingSetToken) {
                            filter['rebalancingSetToken'] = rebalancingSetToken;
                        }
                        return [4 /*yield*/, rebalancingSetEthBidderInstance.getPastEvents('BidPlacedWithEth', {
                                'fromBlock': fromBlock,
                                'toBlock': toBlock,
                                'filter': filter,
                            })];
     ...
     */
    RebalancingSetEthBidderWrapper.prototype.bidAndWithdrawWithEther = function (rebalancingSetTokenAddress, quantity, allowPartialFill, txOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var txSettings, rebalancingSetEthBidderInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, util_1.generateTxOpts(this.web3, txOpts)];
                    case 1:
                        txSettings = _a.sent();
                        return [4 /*yield*/, this.contracts.loadRebalancingSetEthBidderContract(this.rebalancingSetEthBidderAddress)];
                    case 2:
                        rebalancingSetEthBidderInstance = _a.sent();
                        return [4 /*yield*/, rebalancingSetEthBidderInstance.bidAndWithdrawWithEther.sendTransactionAsync(rebalancingSetTokenAddress, quantity, allowPartialFill, txSettings)];
                    case 3: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    return RebalancingSetEthBidderWrapper;
}());
exports.RebalancingSetEthBidderWrapper = RebalancingSetEthBidderWrapper;
//# sourceMappingURL=RebalancingSetEthBidderWrapper.js.map
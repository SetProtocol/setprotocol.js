...
import { BidderWrapper } from '@src/wrappers';
import {
  ONE_DAY_IN_SECONDS,
...
describe('BidderWrapper', () => {
  ...
  let bidderWrapper: BidderWrapper;
  ...
  beforeEach(async () => {
    ...
    bidderWrapper = new BidderWrapper(
      web3,
      bidder.address,
    );
  });
  ...
  describe('#getTokenFlows', async () => {
    ...
    async function subject(): Promise<any> {
      return await bidderWrapper.getTokenFlows(
  ...
  describe('#getSpread', async () => {
    ...
    async function subject(): Promise<any> {
      return bidderWrapper.getSpread(
        subjectRebalancingSetToken,
        subjectQuantity,
  ...
  describe('#bidAndExchangeWithWallet', async () => {
    ...
    async function subject(): Promise<any> {
      return bidderWrapper.bidAndExchangeWithWallet(
        subjectRebalancingSetToken,
        subjectQuantity,
        subjectBenchmarkToken,

...
export class OrderAPI {
  ...
  public async isValidSignatureOrThrowAsync(
    ...
    signature: ECSig,
    addSignaturePrefix: boolean = false,
  ): Promise<boolean> {
  ...
  public async signOrderAsync(
    ...
    return await this.setProtocolUtils.signMessage(orderHash, txOpts.from, addSignaturePrefix);
  }
   ...
   * @param  addSignaturePrefix          Optional parameter if the signature is generated by metamask
  ...
  public async createSignedOrderAsync(
    ...
    const signature = await this.setProtocolUtils.signMessage(orderHash, makerAddress, addSignaturePrefix);

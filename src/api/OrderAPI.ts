...
export class OrderAPI {
  ...
  public async signOrderAsync(
    ...
    return await this.setProtocolUtils.signMessage(orderHash, txOpts.from, addPrefix);
  }
   ...
   * @param  isMetamaskSigner            Optional parameter if the signature is generated by metamask
  ...
  public async createSignedOrderAsync(
    ...
    isMetamaskSigner: boolean = false,
    ...
    const signature = await this.setProtocolUtils.signMessage(orderHash, makerAddress, isMetamaskSigner);

...
export const DEFAULT_AUCTION_TIME_TO_PIVOT: BigNumber = new BigNumber(100000);
export const DEFAULT_AUCTION_START_PRICE: BigNumber = new BigNumber(500);
export const DEFAULT_AUCTION_PIVOT_PRICE: BigNumber = new BigNumber(1000);

// Slightly modified typings from https://github.com/0xProject/web3-typescript-typings
...
declare module "web3" {
  ...
  namespace Web3 {
    ...
    interface TransactionReceipt<EventArgs = { [key: string]: string | BigNumber.BigNumber }> {
      blockHash: string;
      blockNumber: number;
      transactionHash: string;

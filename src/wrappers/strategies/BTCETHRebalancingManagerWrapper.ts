...
export class BTCETHRebalancingManagerWrapper {
  ...
  public async propose(
    ...
    const btcEthManagerInstance = await this.contracts.loadBtcEthManagerContractAsync(managerAddress);
  ...
  public async maximumLowerThreshold(managerAddress: Address): Promise<BigNumber> {
    ...
    return await btcEthManagerInstance.maximumLowerThreshold.callAsync();
  }

  public async minimumUpperThreshold(managerAddress: Address): Promise<BigNumber> {
    const btcEthManagerInstance = await this.contracts.loadBtcEthManagerContractAsync(managerAddress);

    return await btcEthManagerInstance.minimumUpperThreshold.callAsync();
  }

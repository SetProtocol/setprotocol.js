        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Promise.all(libraries.map(function (library) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, library.new({ from: from })];
                                case 1:
...
exports.coerceStructBNValuesToString = function (struct) {
    var newObject = {};
...
exports.importArtifactsFromSource = function (contractName) {
    ...
    try {
        var data = require('set-protocol-contracts/dist/artifacts/ts/' + contractName)[contractName];
    ...
    try {
        var filePath = 'set-protocol-contracts-' + package_json_1.version + '/dist/artifacts/ts/' + contractName;

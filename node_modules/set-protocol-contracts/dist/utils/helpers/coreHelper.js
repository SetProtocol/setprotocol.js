...
var Authorizable = web3Helper_1.importArtifactsFromSource('Authorizable');
...
var LimitOneUpgradeMock = web3Helper_1.importArtifactsFromSource('LimitOneUpgradeMock');
...
var TimeLockUpgradeMock = web3Helper_1.importArtifactsFromSource('TimeLockUpgradeMock');
var TimeLockUpgradeV2Mock = web3Helper_1.importArtifactsFromSource('TimeLockUpgradeV2Mock');
var TransferProxy = web3Helper_1.importArtifactsFromSource('TransferProxy');
var UnrestrictedTimeLockUpgradeMock = web3Helper_1.importArtifactsFromSource('UnrestrictedTimeLockUpgradeMock');
...
var CoreHelper = /** @class */ (function () {
    ...
    CoreHelper.prototype.deployAuthorizableAsync = function (from) {
        if (from === void 0) { from = this._tokenOwnerAddress; }
        return __awaiter(this, void 0, void 0, function () {
            var truffleAuthorizable;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Authorizable.new({ from: from, gas: constants_1.DEFAULT_GAS })];
                    case 1:
                        truffleAuthorizable = _a.sent();
                        return [2 /*return*/, new contracts_1.AuthorizableContract(web3Helper_1.getContractInstance(truffleAuthorizable), { from: from, gas: constants_1.DEFAULT_GAS })];
                }
            });
        });
    };
    ...
    CoreHelper.prototype.deployTimeLockUpgradeMockAsync = function (from) {
        if (from === void 0) { from = this._tokenOwnerAddress; }
        return __awaiter(this, void 0, void 0, function () {
            var truffleTimeLockUpgradeMock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, TimeLockUpgradeMock.new({ from: from })];
                    case 1:
                        truffleTimeLockUpgradeMock = _a.sent();
                        return [2 /*return*/, new contracts_1.TimeLockUpgradeMockContract(web3Helper_1.getContractInstance(truffleTimeLockUpgradeMock), { from: from, gas: constants_1.DEFAULT_GAS })];
                }
            });
        });
    };
    CoreHelper.prototype.deployTimeLockUpgradeV2MockAsync = function (from) {
        if (from === void 0) { from = this._tokenOwnerAddress; }
        return __awaiter(this, void 0, void 0, function () {
            var truffleTimeLockUpgradeV2Mock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, TimeLockUpgradeV2Mock.new({ from: from })];
                    case 1:
                        truffleTimeLockUpgradeV2Mock = _a.sent();
                        return [2 /*return*/, new contracts_1.TimeLockUpgradeV2MockContract(web3Helper_1.getContractInstance(truffleTimeLockUpgradeV2Mock), { from: from, gas: constants_1.DEFAULT_GAS })];
                }
            });
        });
    };
    CoreHelper.prototype.deployUnrestrictedTimeLockUpgradeMockAsync = function (from) {
        if (from === void 0) { from = this._tokenOwnerAddress; }
        return __awaiter(this, void 0, void 0, function () {
            var truffleUnrestrictedTimeLockUpgradeMock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, UnrestrictedTimeLockUpgradeMock.new({ from: from })];
                    case 1:
                        truffleUnrestrictedTimeLockUpgradeMock = _a.sent();
                        return [2 /*return*/, new contracts_1.UnrestrictedTimeLockUpgradeMockContract(web3Helper_1.getContractInstance(truffleUnrestrictedTimeLockUpgradeMock), { from: from, gas: constants_1.DEFAULT_GAS })];
                }
            });
        });
    };
    CoreHelper.prototype.deployLimitOneUpgradeMockAsync = function (from) {
        if (from === void 0) { from = this._tokenOwnerAddress; }
        return __awaiter(this, void 0, void 0, function () {
            var truffleLimitOneUpgradeMock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, LimitOneUpgradeMock.new({ from: from })];
                    case 1:
                        truffleLimitOneUpgradeMock = _a.sent();
                        return [2 /*return*/, new contracts_1.LimitOneUpgradeMockContract(web3Helper_1.getContractInstance(truffleLimitOneUpgradeMock), { from: from, gas: constants_1.DEFAULT_GAS })];
                }
            });
        });
    };

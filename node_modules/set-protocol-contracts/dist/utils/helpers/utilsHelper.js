...
var UtilsHelper = /** @class */ (function () {
    function UtilsHelper(tokenOwnerAddress) {
        this._tokenOwnerAddress = tokenOwnerAddress;
    }
    /* ============ Deployment ============ */
    UtilsHelper.prototype.deployAddressToAddressWhiteListAsync = function (initialKeyTypeAddresses, initialValueTypeAddresses, from) {

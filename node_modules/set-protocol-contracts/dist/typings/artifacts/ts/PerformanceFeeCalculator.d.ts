export declare const PerformanceFeeCalculator: {
    "contractName": string;
    "abi": ({
        "constant": boolean;
        "inputs": {
    ...
    "ast": {
        "absolutePath": string;
        "exportedSymbols": {
            "PerformanceFeeCalculator": number[];
        };
        "id": number;
        "nodeType": string;
        "nodes": ({
    ...
    "devdoc": {
        ...
        "methods": {
            "constructor": {
                "params": {
                    "_core": string;
                    "_maximumProfitFeePercentage": string;
                    "_maximumStreamingFeePercentage": string;
                    "_oracleWhiteList": string;
                };
            };
            "getCalculatedFees(address)": {
                "params": {
                    "_setAddress": string;
                };
                "return": string;

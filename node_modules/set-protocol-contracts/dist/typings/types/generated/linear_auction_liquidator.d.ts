...
export declare class LinearAuctionLiquidatorContract extends BaseContract {
    name: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<LinearAuctionLiquidatorContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<LinearAuctionLiquidatorContract>;

...
export declare class UnrestrictedTimeLockUpgradeContract extends BaseContract {
    timeLockedUpgrades: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<UnrestrictedTimeLockUpgradeContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<UnrestrictedTimeLockUpgradeContract>;

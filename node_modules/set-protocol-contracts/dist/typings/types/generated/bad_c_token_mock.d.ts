...
export declare class BadCTokenMockContract extends BaseContract {
    name: {
    ...
    mint: {
        ...
        callAsync(_value: BigNumber, txData?: Tx): Promise<BigNumber>;
    };
    redeem: {
        sendTransactionAsync(_value: BigNumber, txData?: Tx): Promise<string>;
        estimateGasAsync(_value: BigNumber, txData?: Tx): Promise<number>;
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<BadCTokenMockContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<BadCTokenMockContract>;

...
export declare class LiquidatorProxyContract extends BaseContract {
    rebalanceFailPeriod: {
    ...
    setAuctionFailPeriod: {
        sendTransactionAsync(_newFailPeriod: BigNumber, txData?: Tx): Promise<string>;
        estimateGasAsync(_newFailPeriod: BigNumber, txData?: Tx): Promise<number>;
        getABIEncodedTransactionData(_newFailPeriod: BigNumber, txData?: Tx): string;
        callAsync(_newFailPeriod: BigNumber, txData?: Tx): Promise<void>;
    };
    deploy(data: string, args: any[]): Promise<any>;
    static deployed(web3: Web3, defaults: Tx): Promise<LiquidatorProxyContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<LiquidatorProxyContract>;

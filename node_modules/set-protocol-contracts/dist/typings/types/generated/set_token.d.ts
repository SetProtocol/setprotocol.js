...
export declare class SetTokenContract extends BaseContract {
    name: {
    ...
    units: {
        callAsync(index_0: BigNumber, defaultBlock?: any): Promise<BigNumber>;
    };
    mint: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<SetTokenContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<SetTokenContract>;

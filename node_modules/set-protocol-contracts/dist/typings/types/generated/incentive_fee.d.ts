...
export declare class IncentiveFeeContract extends BaseContract {
    unitShares: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<IncentiveFeeContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<IncentiveFeeContract>;

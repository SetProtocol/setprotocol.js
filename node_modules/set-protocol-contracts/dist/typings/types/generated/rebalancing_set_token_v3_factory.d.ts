...
export declare class RebalancingSetTokenV3FactoryContract extends BaseContract {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<RebalancingSetTokenV3FactoryContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<RebalancingSetTokenV3FactoryContract>;

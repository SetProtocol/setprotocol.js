...
export declare class RebalancingSetCTokenIssuanceModuleContract extends BaseContract {
    weth: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<RebalancingSetCTokenIssuanceModuleContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<RebalancingSetCTokenIssuanceModuleContract>;

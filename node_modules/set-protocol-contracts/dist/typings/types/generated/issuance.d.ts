...
export declare class IssuanceContract extends BaseContract {
    unitShares: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<IssuanceContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<IssuanceContract>;

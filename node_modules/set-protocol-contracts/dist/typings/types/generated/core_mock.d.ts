...
export declare class CoreMockContract extends BaseContract {
    withdrawModule: {
    ...
    issueModule: {
        sendTransactionAsync(_componentOwner: string, _setRecipient: string, _set: string, _quantity: BigNumber, txData?: Tx): Promise<string>;
        estimateGasAsync(_componentOwner: string, _setRecipient: string, _set: string, _quantity: BigNumber, txData?: Tx): Promise<number>;
        getABIEncodedTransactionData(_componentOwner: string, _setRecipient: string, _set: string, _quantity: BigNumber, txData?: Tx): string;
        callAsync(_componentOwner: string, _setRecipient: string, _set: string, _quantity: BigNumber, txData?: Tx): Promise<void>;
    };
    issue: {
        sendTransactionAsync(_set: string, _quantity: BigNumber, txData?: Tx): Promise<string>;
        estimateGasAsync(_set: string, _quantity: BigNumber, txData?: Tx): Promise<number>;
    ...
    mint: {
        sendTransactionAsync(_set: string, _issuer: string, _quantity: BigNumber, txData?: Tx): Promise<string>;
        estimateGasAsync(_set: string, _issuer: string, _quantity: BigNumber, txData?: Tx): Promise<number>;
        getABIEncodedTransactionData(_set: string, _issuer: string, _quantity: BigNumber, txData?: Tx): string;
        callAsync(_set: string, _issuer: string, _quantity: BigNumber, txData?: Tx): Promise<void>;
    };
    burn: {
        sendTransactionAsync(_set: string, _from: string, _quantity: BigNumber, txData?: Tx): Promise<string>;
        estimateGasAsync(_set: string, _from: string, _quantity: BigNumber, txData?: Tx): Promise<number>;
        getABIEncodedTransactionData(_set: string, _from: string, _quantity: BigNumber, txData?: Tx): string;
        callAsync(_set: string, _from: string, _quantity: BigNumber, txData?: Tx): Promise<void>;
    };
    addSet: {
        sendTransactionAsync(_set: string, txData?: Tx): Promise<string>;
        estimateGasAsync(_set: string, txData?: Tx): Promise<number>;
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<CoreMockContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<CoreMockContract>;

...
export declare class RebalancingSetTokenV2Contract extends BaseContract {
    unitShares: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<RebalancingSetTokenV2Contract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<RebalancingSetTokenV2Contract>;

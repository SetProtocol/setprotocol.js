...
export declare class IRebalancingSetTokenV2Contract extends BaseContract {
    totalSupply: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<IRebalancingSetTokenV2Contract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<IRebalancingSetTokenV2Contract>;

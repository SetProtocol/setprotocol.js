...
export declare class RebalancingFailureContract extends BaseContract {
    unitShares: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<RebalancingFailureContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<RebalancingFailureContract>;

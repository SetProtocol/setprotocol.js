...
export declare class TimeLockUpgradeV2MockContract extends BaseContract {
    timeLockedUpgrades: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<TimeLockUpgradeV2MockContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<TimeLockUpgradeV2MockContract>;

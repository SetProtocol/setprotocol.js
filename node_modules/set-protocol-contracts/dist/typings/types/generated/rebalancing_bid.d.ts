...
export declare class RebalancingBidContract extends BaseContract {
    unitShares: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<RebalancingBidContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<RebalancingBidContract>;

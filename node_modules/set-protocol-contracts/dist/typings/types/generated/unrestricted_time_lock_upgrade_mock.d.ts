...
export declare class UnrestrictedTimeLockUpgradeMockContract extends BaseContract {
    timeLockedUpgrades: {
    ...
    testTimeLockUpgrade: {
        sendTransactionAsync(_testUint: BigNumber, txData?: Tx): Promise<string>;
        estimateGasAsync(_testUint: BigNumber, txData?: Tx): Promise<number>;
        getABIEncodedTransactionData(_testUint: BigNumber, txData?: Tx): string;
        callAsync(_testUint: BigNumber, txData?: Tx): Promise<void>;
    };
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<UnrestrictedTimeLockUpgradeMockContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<UnrestrictedTimeLockUpgradeMockContract>;

...
export declare class RebalancingStartContract extends BaseContract {
    unitShares: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<RebalancingStartContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<RebalancingStartContract>;

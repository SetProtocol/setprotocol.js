...
var SetMathContract = /** @class */ (function (_super) {
    __extends(SetMathContract, _super);
    function SetMathContract(web3ContractInstance, defaults) {
    ...
    SetMathContract.prototype.deploy = function (data, args) {
    ...
    SetMathContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = require('../../artifacts/ts/SetMath').SetMath, abi = _a.abi, networks = _a.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new SetMathContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    SetMathContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = require('../../artifacts/ts/SetMath').SetMath.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('SetMath', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return SetMathContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.SetMathContract = SetMathContract;

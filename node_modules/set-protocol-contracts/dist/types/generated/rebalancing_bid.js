...
var RebalancingBidContract = /** @class */ (function (_super) {
    __extends(RebalancingBidContract, _super);
    function RebalancingBidContract(web3ContractInstance, defaults) {
    ...
    RebalancingBidContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    RebalancingBidContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = require('../../artifacts/ts/RebalancingBid').RebalancingBid, abi = _a.abi, networks = _a.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new RebalancingBidContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    RebalancingBidContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = require('../../artifacts/ts/RebalancingBid').RebalancingBid.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('RebalancingBid', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return RebalancingBidContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.RebalancingBidContract = RebalancingBidContract;

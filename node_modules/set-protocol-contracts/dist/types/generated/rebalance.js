...
var RebalanceContract = /** @class */ (function (_super) {
    __extends(RebalanceContract, _super);
    function RebalanceContract(web3ContractInstance, defaults) {
    ...
    RebalanceContract.prototype.deploy = function (data, args) {
    ...
    RebalanceContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = require('../../artifacts/ts/Rebalance').Rebalance, abi = _a.abi, networks = _a.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new RebalanceContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    RebalanceContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = require('../../artifacts/ts/Rebalance').Rebalance.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('Rebalance', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
...
exports.RebalanceContract = RebalanceContract;

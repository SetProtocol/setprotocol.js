...
class Package {
    ...
    hasVersion(version) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.packageContract.methods
                .hasVersion(Semver_1.toSemanticVersion(version))
                .call();
        });
    }
    isFrozen(version) {
    ...
    getDirectory(version) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const directoryAddress = yield this.packageContract.methods
                .getContract(Semver_1.toSemanticVersion(version))
                .call();

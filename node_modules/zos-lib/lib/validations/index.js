...
function newValidationErrors(validations, existingValidations = {}) {
    return {
        ...
        hasInitialValuesInDeclarations: validations.hasInitialValuesInDeclarations &&
            !existingValidations.hasInitialValuesInDeclarations,
...
function tryGetUninitializedBaseContracts(contract) {
    try {
        ...
        Logger_1.Loggy.noSpin.error(__filename, 'tryGetUninitializedBaseContracts', 'try-get-uninitialized-base-contracts', `- Skipping uninitialized base contracts validation due to error: ${error.message}`);
        return [];
    }
}
function checkArtifactsForImportedSources(contract, buildArtifacts) {
    new ContractAST_1.default(contract, buildArtifacts, {

...
function getContractInitializer(contract) {
    const contractDefinition = contract.schema.ast.nodes.find((n) => n.nodeType === 'ContractDefinition' &&
        n.name === contract.schema.contractName);
    ...
    for (const contractFunction of contractFunctions) {
        ...
        if (contractFunction.name === 'initialize' ||
            initializerModifier !== undefined) {

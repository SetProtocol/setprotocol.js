...
class BaseAppProject extends BasePackageProject_1.default {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (yield thepackage.hasVersion(version)) {
                    ...
                    const succeedText = !appAddress || !packageAddress
    ...
    getContractInterface(contract, opts = {}) {
        ...
        if (!lodash_isempty_1.default(opts.initArgs) && !initMethod) {
            initMethod = 'initialize';
        }
        return Object.assign({}, opts, { contractName, packageName, initMethod });
    }
    ...
    getProxyDeploymentSigner(contract, salt, signature, { packageName, contractName, initMethod, initArgs, admin, } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const initData = initMethod
                ? ABIs_1.buildCallData(contract, initMethod, initArgs).callData
                : null;
    ...
    getAndLogInitCallData(contract, initMethodName, initArgs, implementationAddress, actionLabel, proxyAddress) {
        const logReference = actionLabel === 'Creating'
            ? 'create-proxy'
        ...
        if (initMethodName) {
            ...
            if (actionLabel)
                Logger_1.Loggy.spin(__filename, 'getAndLogInitCallData', `${__filename}#getAndLogInitCallData`, logReference, logMessage);
            return null;
        }
    }
}

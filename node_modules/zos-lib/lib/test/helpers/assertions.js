...
function assertions(chai, utils) {
    ...
    Assertion.addProperty('nonzeroAddress', function () {
        this.assert(this._obj &&
            ...
            this._obj !== Addresses_1.ZERO_ADDRESS, 'expected #{this} to be a non-zero address', 'expected #{this} to not be a non-zero address');
    });
    Assertion.addProperty('zeroAddress', function () {
        this.assert(this._obj &&
            this._obj.length === 42 &&
            this._obj.startsWith('0x') &&
            this._obj === Addresses_1.ZERO_ADDRESS, 'expected #{this} to be a zero address', 'expected #{this} to not be a zero address');
    });

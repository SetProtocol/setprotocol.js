...
declare const _default: {
     ...
     */
    sendDataTransaction(contract: Contract, txParams: TxParams, retries?: number): Promise<TransactionReceipt>;
    ...
    _sendContractDataTransaction(contract: Contract, txParams: TxParams): Promise<TransactionReceipt>;

    ...
    sendRawTransaction(address, { data, value }, txParams = {}, retries = RETRY_COUNT) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return ZWeb3_1.default.eth().sendTransaction(Object.assign({ to: address, data,
                    value,
                    from }, txParams, { gas }));
            }
            catch (error) {
    ...
    sendDataTransaction(contract, txParams, retries = RETRY_COUNT) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const gas = txParams.gas ||
                    Contracts_1.default.getArtifactsDefaults().gas ||
                    (yield this.estimateActualGas(Object.assign({ to: contract.address }, txParams)));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                if (+new Date() - now > timeout)
                    throw new Error(`Exceeded timeout of ${timeout /
    ...
    _fixGasPrice(txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((TRUFFLE_DEFAULT_GAS_PRICE.eq(gasPrice) || !gasPrice) &&
                (yield ZWeb3_1.default.isMainnet())) {

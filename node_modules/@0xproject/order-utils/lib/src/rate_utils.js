...
exports.rateUtils = {
    ...
    getFeeAdjustedRateOfOrder: function (order, feeRate) {
        ...
        var takerAssetAmountNeededToPayForFees = order.takerFee.mul(feeRate);
    ...
    getFeeAdjustedRateOfFeeOrder: function (feeOrder) {
        ...
        var zrxAmountAfterFees = feeOrder.makerAssetAmount.sub(feeOrder.takerFee);
        assert_1.assert.assert(zrxAmountAfterFees.greaterThan(constants_1.constants.ZERO_AMOUNT), "Expected takerFee: " + JSON.stringify(feeOrder.takerFee) + " to be less than makerAssetAmount: " + JSON.stringify(feeOrder.makerAssetAmount));

...
exports.assert = __assign({}, assert_1.assert, { isSenderAddressAsync: function (variableName, senderAddressHex, web3Wrapper) {
    ...
    isOneOfExpectedSignatureTypes: function (signature, signatureTypes) {

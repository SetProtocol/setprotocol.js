...
var Web3Wrapper = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._sendRawPayloadAsync({
    ...
    Web3Wrapper.prototype.getBlockNumberAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._sendRawPayloadAsync({
    ...
    Web3Wrapper.prototype.getBlockAsync = function (blockParam) {
        return __awaiter(this, void 0, void 0, function () {
            var encodedBlockParam, method, shouldIncludeTransactionData, blockWithoutTransactionDataWithHexValues, blockWithoutTransactionData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        blockWithoutTransactionDataWithHexValues = _a.sent();
                        blockWithoutTransactionData = marshaller_1.marshaller.unmarshalIntoBlockWithoutTransactionData(blockWithoutTransactionDataWithHexValues);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        Web3Wrapper._assertBlockParamOrString(blockParam);
                        return [4 /*yield*/, this.getBlockAsync(blockParam)];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._sendRawPayloadAsync({ method: 'evm_revert', params: [snapshotId] })];
                    case 1:
                        didRevert = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (_.includes(version, uniqueVersionIds.geth)) {
                            return [2 /*return*/, this._sendRawPayloadAsync({ method: 'debug_increaseTime', params: [timeDelta] })];
                        }
                        else if (_.includes(version, uniqueVersionIds.ganache)) {
                            return [2 /*return*/, this._sendRawPayloadAsync({ method: 'evm_increaseTime', params: [timeDelta] })];
                        }
                        else {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._sendRawPayloadAsync({ method: 'eth_estimateGas', params: [txDataHex] })];
                    case 1:
                        gasHex = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        txDataHex = marshaller_1.marshaller.marshalTxData(txData);
                        return [4 /*yield*/, this._sendRawPayloadAsync({ method: 'eth_sendTransaction', params: [txDataHex] })];
                    case 1:
                        txHash = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._sendRawPayloadAsync({ method: 'debug_setHead', params: [utils_2.utils.numberToHex(blockNumber)] })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }

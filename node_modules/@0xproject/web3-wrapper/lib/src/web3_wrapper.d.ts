...
import { BlockParam, BlockWithoutTransactionData, BlockWithTransactionData, CallData, FilterObject, LogEntry, Provider, TraceParams, Transaction, TransactionReceipt, TransactionReceiptWithDecodedLogs, TransactionTrace, TxData } from 'ethereum-types';

...
describe('Web3Wrapper tests', function () {
    ...
    describe('#getBlockAsync', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, web3Wrapper.getBlockAsync(blockParamLiteral)];
                    case 1:
                        block = _a.sent();
        ...
        it('gets block when supplied a block hash', function () { return __awaiter(_this, void 0, void 0, function () {
            var blockParamLiteral, block, sameBlock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        blockParamLiteral = 0;
                    ...
                    case 1:
                        block = _a.sent();
                        return [4 /*yield*/, web3Wrapper.getBlockAsync(block.hash)];
                    case 2:
                        sameBlock = _a.sent();

...
exports.constants = {
    ...
    SET_FULL_TOKEN_UNITS: new bignumber_1.BigNumber(Math.pow(10, 18)),
    UNLIMITED_ALLOWANCE_IN_BASE_UNITS: new bignumber_1.BigNumber(2).pow(256).minus(1),
    WBTC_FULL_TOKEN_UNITS: new bignumber_1.BigNumber(Math.pow(10, 8)),
    WETH_FULL_TOKEN_UNITS: new bignumber_1.BigNumber(Math.pow(10, 18)),
    ZERO: new bignumber_1.BigNumber(0),

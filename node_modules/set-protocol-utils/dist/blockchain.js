...
var Blockchain = /** @class */ (function () {
    ...
    Blockchain.prototype.increaseTimeAsync = function (duration) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendJSONRpcRequestAsync('evm_increaseTime', [duration.toNumber()])];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Blockchain.prototype.mineBlockAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendJSONRpcRequestAsync('evm_mine', [])];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Blockchain.prototype.sendJSONRpcRequestAsync = function (method, params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, tiny_promisify_1.default(this._web3.currentProvider.send, {

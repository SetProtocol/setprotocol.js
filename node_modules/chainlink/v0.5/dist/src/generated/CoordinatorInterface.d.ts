...
interface CoordinatorInterfaceInterface extends Interface {
  functions: {
    ...
    initiateServiceAgreement: TypedFunctionDescription<{
      encode([_agreement, _signatures]: [
        {
          payment: BigNumberish;
          expiration: BigNumberish;
          endAt: BigNumberish;
          oracles: (string)[];
          requestDigest: Arrayish;
          aggregator: string;
          aggInitiateJobSelector: Arrayish;
          aggFulfillSelector: Arrayish;
        },
        { vs: (BigNumberish)[]; rs: (Arrayish)[]; ss: (Arrayish)[] }
      ]): string;
    }>;
  };
...
export class CoordinatorInterface extends Contract {
  ...
  functions: {
    ...
    initiateServiceAgreement(
      ...
      _signatures: { vs: (BigNumberish)[]; rs: (Arrayish)[]; ss: (Arrayish)[] },
      overrides?: TransactionOverrides
    ): Promise<ContractTransaction>;
  };

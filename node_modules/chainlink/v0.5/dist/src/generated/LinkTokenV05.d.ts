...
interface LinkTokenV05Interface extends Interface {
  functions: {
...
export class LinkTokenV05 extends Contract {
  connect(signerOrProvider: Signer | Provider | string): LinkTokenV05;
  attach(addressOrName: string): LinkTokenV05;
  deployed(): Promise<LinkTokenV05>;

  on(event: EventFilter | string, listener: Listener): LinkTokenV05;
  once(event: EventFilter | string, listener: Listener): LinkTokenV05;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): LinkTokenV05;
  removeAllListeners(eventName: EventFilter | string): LinkTokenV05;
  removeListener(eventName: any, listener: Listener): LinkTokenV05;

  interface: LinkTokenV05Interface;

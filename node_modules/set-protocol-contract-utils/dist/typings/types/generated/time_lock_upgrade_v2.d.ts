...
export declare class TimeLockUpgradeV2Contract extends BaseContract {
    timeLockedUpgrades: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<TimeLockUpgradeV2Contract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<TimeLockUpgradeV2Contract>;

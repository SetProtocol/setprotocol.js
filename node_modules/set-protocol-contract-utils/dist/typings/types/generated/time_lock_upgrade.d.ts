...
export declare class TimeLockUpgradeContract extends BaseContract {
    timeLockedUpgrades: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<TimeLockUpgradeContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<TimeLockUpgradeContract>;

...
export declare class TimeLockUpgradeMockContract extends BaseContract {
    timeLockedUpgrades: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<TimeLockUpgradeMockContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<TimeLockUpgradeMockContract>;

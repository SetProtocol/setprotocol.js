...
var LimitOneUpgradeMock_1 = require("../../artifacts/ts/LimitOneUpgradeMock");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var LimitOneUpgradeMockContract = /** @class */ (function (_super) {
    __extends(LimitOneUpgradeMockContract, _super);
    function LimitOneUpgradeMockContract(web3ContractInstance, defaults) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.testUint().call, self.web3ContractInstance)()];
                            case 1:
                                result = _a.sent();
                                return [2 /*return*/, new set_protocol_utils_1.BigNumber(result)];
                        }
        ...
        _this.testLimitOneUpgrade = {
            sendTransactionAsync: function (_upgradeAddress, _testUint, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, self.applyDefaultsToTxDataAsync(txData, self.testLimitOneUpgrade.estimateGasAsync.bind(self, this.formatABIDataItem('address', [], _upgradeAddress), this.formatABIDataItem('uint256', [], _testUint)))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.testLimitOneUpgrade(this.formatABIDataItem('address', [], _upgradeAddress), this.formatABIDataItem('uint256', [], _testUint)).send, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            estimateGasAsync: function (_upgradeAddress, _testUint, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, gas;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.testLimitOneUpgrade(this.formatABIDataItem('address', [], _upgradeAddress), this.formatABIDataItem('uint256', [], _testUint)).estimateGas, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
            ...
            getABIEncodedTransactionData: function (_upgradeAddress, _testUint, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.methods.testLimitOneUpgrade(this.formatABIDataItem('address', [], _upgradeAddress), this.formatABIDataItem('uint256', [], _testUint)).encodeABI();
                return abiEncodedTransactionData;
            },
            callAsync: function (_upgradeAddress, _testUint, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.testLimitOneUpgrade(this.formatABIDataItem('address', [], _upgradeAddress), this.formatABIDataItem('uint256', [], _testUint)).call, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                result = _a.sent();
                                return [2 /*return*/, result];
                        }
        ...
        _this.removeRegisteredUpgrade = {
            sendTransactionAsync: function (_upgradeAddress, _upgradeHash, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, self.applyDefaultsToTxDataAsync(txData, self.removeRegisteredUpgrade.estimateGasAsync.bind(self, this.formatABIDataItem('address', [], _upgradeAddress), this.formatABIDataItem('bytes32', [], _upgradeHash)))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.removeRegisteredUpgrade(this.formatABIDataItem('address', [], _upgradeAddress), this.formatABIDataItem('bytes32', [], _upgradeHash)).send, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            estimateGasAsync: function (_upgradeAddress, _upgradeHash, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, gas;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.removeRegisteredUpgrade(this.formatABIDataItem('address', [], _upgradeAddress), this.formatABIDataItem('bytes32', [], _upgradeHash)).estimateGas, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
            ...
            getABIEncodedTransactionData: function (_upgradeAddress, _upgradeHash, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.methods.removeRegisteredUpgrade(this.formatABIDataItem('address', [], _upgradeAddress), this.formatABIDataItem('bytes32', [], _upgradeHash)).encodeABI();
                return abiEncodedTransactionData;
            },
            callAsync: function (_upgradeAddress, _upgradeHash, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.removeRegisteredUpgrade(this.formatABIDataItem('address', [], _upgradeAddress), this.formatABIDataItem('bytes32', [], _upgradeHash)).call, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                result = _a.sent();
                                return [2 /*return*/, result];
                        }
    ...
    LimitOneUpgradeMockContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    LimitOneUpgradeMockContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = LimitOneUpgradeMock_1.LimitOneUpgradeMock.abi, networks = LimitOneUpgradeMock_1.LimitOneUpgradeMock.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new LimitOneUpgradeMockContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    LimitOneUpgradeMockContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = LimitOneUpgradeMock_1.LimitOneUpgradeMock.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('LimitOneUpgradeMock', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return LimitOneUpgradeMockContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.LimitOneUpgradeMockContract = LimitOneUpgradeMockContract;
//# sourceMappingURL=limit_one_upgrade_mock.js.map
...
var UnrestrictedTimeLockUpgradeMock_1 = require("../../artifacts/ts/UnrestrictedTimeLockUpgradeMock");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var UnrestrictedTimeLockUpgradeMockContract = /** @class */ (function (_super) {
    __extends(UnrestrictedTimeLockUpgradeMockContract, _super);
    function UnrestrictedTimeLockUpgradeMockContract(web3ContractInstance, defaults) {
        ...
        _this.testTimeLockUpgrade = {
            sendTransactionAsync: function (_testUint, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, self.applyDefaultsToTxDataAsync(txData, self.testTimeLockUpgrade.estimateGasAsync.bind(self, this.formatABIDataItem('uint256', [], _testUint)))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.testTimeLockUpgrade(this.formatABIDataItem('uint256', [], _testUint)).send, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            estimateGasAsync: function (_testUint, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, gas;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.testTimeLockUpgrade(this.formatABIDataItem('uint256', [], _testUint)).estimateGas, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
            ...
            getABIEncodedTransactionData: function (_testUint, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.methods.testTimeLockUpgrade(this.formatABIDataItem('uint256', [], _testUint)).encodeABI();
                return abiEncodedTransactionData;
            },
            callAsync: function (_testUint, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.testTimeLockUpgrade(this.formatABIDataItem('uint256', [], _testUint)).call, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                result = _a.sent();
                                return [2 /*return*/, result];
                        }
    ...
    UnrestrictedTimeLockUpgradeMockContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    UnrestrictedTimeLockUpgradeMockContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = UnrestrictedTimeLockUpgradeMock_1.UnrestrictedTimeLockUpgradeMock.abi, networks = UnrestrictedTimeLockUpgradeMock_1.UnrestrictedTimeLockUpgradeMock.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new UnrestrictedTimeLockUpgradeMockContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    UnrestrictedTimeLockUpgradeMockContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = UnrestrictedTimeLockUpgradeMock_1.UnrestrictedTimeLockUpgradeMock.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('UnrestrictedTimeLockUpgradeMock', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return UnrestrictedTimeLockUpgradeMockContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.UnrestrictedTimeLockUpgradeMockContract = UnrestrictedTimeLockUpgradeMockContract;
//# sourceMappingURL=unrestricted_time_lock_upgrade_mock.js.map
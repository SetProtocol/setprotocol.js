...
var Ownable_1 = require("../../artifacts/ts/Ownable");
...
var OwnableContract = /** @class */ (function (_super) {
    ...
    function OwnableContract(web3ContractInstance, defaults) {
    ...
    OwnableContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    OwnableContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = Ownable_1.Ownable.abi, networks = Ownable_1.Ownable.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new OwnableContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    OwnableContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = Ownable_1.Ownable.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('Ownable', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });

...
var CompoundUtils_1 = require("../../artifacts/ts/CompoundUtils");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var CompoundUtilsContract = /** @class */ (function (_super) {
    __extends(CompoundUtilsContract, _super);
    function CompoundUtilsContract(web3ContractInstance, defaults) {
    ...
    CompoundUtilsContract.prototype.deploy = function (data, args) {
    ...
    CompoundUtilsContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = CompoundUtils_1.CompoundUtils.abi, networks = CompoundUtils_1.CompoundUtils.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new CompoundUtilsContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    CompoundUtilsContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = CompoundUtils_1.CompoundUtils.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('CompoundUtils', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return CompoundUtilsContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.CompoundUtilsContract = CompoundUtilsContract;
//# sourceMappingURL=compound_utils.js.map
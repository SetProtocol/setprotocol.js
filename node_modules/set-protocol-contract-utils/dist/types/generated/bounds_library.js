...
var BoundsLibrary_1 = require("../../artifacts/ts/BoundsLibrary");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var BoundsLibraryContract = /** @class */ (function (_super) {
    __extends(BoundsLibraryContract, _super);
    function BoundsLibraryContract(web3ContractInstance, defaults) {
    ...
    BoundsLibraryContract.prototype.deploy = function (data, args) {
    ...
    BoundsLibraryContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = BoundsLibrary_1.BoundsLibrary.abi, networks = BoundsLibrary_1.BoundsLibrary.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new BoundsLibraryContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    BoundsLibraryContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = BoundsLibrary_1.BoundsLibrary.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('BoundsLibrary', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return BoundsLibraryContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.BoundsLibraryContract = BoundsLibraryContract;
//# sourceMappingURL=bounds_library.js.map
...
var TimeLockUpgradeV2_1 = require("../../artifacts/ts/TimeLockUpgradeV2");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var TimeLockUpgradeV2Contract = /** @class */ (function (_super) {
    __extends(TimeLockUpgradeV2Contract, _super);
    function TimeLockUpgradeV2Contract(web3ContractInstance, defaults) {
    ...
    TimeLockUpgradeV2Contract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    TimeLockUpgradeV2Contract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = TimeLockUpgradeV2_1.TimeLockUpgradeV2.abi, networks = TimeLockUpgradeV2_1.TimeLockUpgradeV2.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new TimeLockUpgradeV2Contract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    TimeLockUpgradeV2Contract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = TimeLockUpgradeV2_1.TimeLockUpgradeV2.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('TimeLockUpgradeV2', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return TimeLockUpgradeV2Contract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.TimeLockUpgradeV2Contract = TimeLockUpgradeV2Contract;
//# sourceMappingURL=time_lock_upgrade_v2.js.map
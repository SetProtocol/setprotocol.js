...
var TimeLockUpgradeMock_1 = require("../../artifacts/ts/TimeLockUpgradeMock");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var TimeLockUpgradeMockContract = /** @class */ (function (_super) {
    __extends(TimeLockUpgradeMockContract, _super);
    function TimeLockUpgradeMockContract(web3ContractInstance, defaults) {
    ...
    TimeLockUpgradeMockContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    TimeLockUpgradeMockContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = TimeLockUpgradeMock_1.TimeLockUpgradeMock.abi, networks = TimeLockUpgradeMock_1.TimeLockUpgradeMock.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new TimeLockUpgradeMockContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    TimeLockUpgradeMockContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = TimeLockUpgradeMock_1.TimeLockUpgradeMock.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('TimeLockUpgradeMock', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return TimeLockUpgradeMockContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.TimeLockUpgradeMockContract = TimeLockUpgradeMockContract;
//# sourceMappingURL=time_lock_upgrade_mock.js.map
...
var SafeMath_1 = require("../../artifacts/ts/SafeMath");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var SafeMathContract = /** @class */ (function (_super) {
    __extends(SafeMathContract, _super);
    function SafeMathContract(web3ContractInstance, defaults) {
    ...
    SafeMathContract.prototype.deploy = function (data, args) {
    ...
    SafeMathContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = SafeMath_1.SafeMath.abi, networks = SafeMath_1.SafeMath.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new SafeMathContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    SafeMathContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = SafeMath_1.SafeMath.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('SafeMath', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
...
exports.SafeMathContract = SafeMathContract;

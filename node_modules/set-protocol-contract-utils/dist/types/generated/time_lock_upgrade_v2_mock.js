...
var TimeLockUpgradeV2Mock_1 = require("../../artifacts/ts/TimeLockUpgradeV2Mock");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var TimeLockUpgradeV2MockContract = /** @class */ (function (_super) {
    __extends(TimeLockUpgradeV2MockContract, _super);
    function TimeLockUpgradeV2MockContract(web3ContractInstance, defaults) {
    ...
    TimeLockUpgradeV2MockContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    TimeLockUpgradeV2MockContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = TimeLockUpgradeV2Mock_1.TimeLockUpgradeV2Mock.abi, networks = TimeLockUpgradeV2Mock_1.TimeLockUpgradeV2Mock.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new TimeLockUpgradeV2MockContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    TimeLockUpgradeV2MockContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = TimeLockUpgradeV2Mock_1.TimeLockUpgradeV2Mock.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('TimeLockUpgradeV2Mock', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return TimeLockUpgradeV2MockContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.TimeLockUpgradeV2MockContract = TimeLockUpgradeV2MockContract;
//# sourceMappingURL=time_lock_upgrade_v2_mock.js.map
...
exports.importArtifactsFromSource = function (contractName) {
    ...
    try {
        var data = require('set-protocol-oracles/dist/artifacts/ts/' + contractName + '.js')[contractName];
    ...
    try {
        var filePath = 'set-protocol-oracles-' + package_json_1.version + '/dist/artifacts/ts/' + contractName + '.js';

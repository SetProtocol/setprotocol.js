...
export declare class StandardTokenMockContract extends BaseContract {
    name: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<StandardTokenMockContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<StandardTokenMockContract>;

...
export declare class LinkedListLibraryMockV3Contract extends BaseContract {
    initializeMock: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<LinkedListLibraryMockV3Contract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<LinkedListLibraryMockV3Contract>;

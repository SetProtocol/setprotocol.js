...
export declare class OracleProxyContract extends BaseContract {
    timeLockedUpgrades: {
        callAsync(index_0: string, defaultBlock?: any): Promise<BigNumber>;
    };
    addAuthorizedAddress: {
        sendTransactionAsync(_authTarget: string, txData?: Tx): Promise<string>;
        estimateGasAsync(_authTarget: string, txData?: Tx): Promise<number>;
        getABIEncodedTransactionData(_authTarget: string, txData?: Tx): string;
        callAsync(_authTarget: string, txData?: Tx): Promise<void>;
    };
    authorities: {
    ...
    changeOracleAddress: {
        sendTransactionAsync(_newOracleAddress: string, txData?: Tx): Promise<string>;
        estimateGasAsync(_newOracleAddress: string, txData?: Tx): Promise<number>;
        getABIEncodedTransactionData(_newOracleAddress: string, txData?: Tx): string;
        callAsync(_newOracleAddress: string, txData?: Tx): Promise<void>;
    };
    deploy(data: string, args: any[]): Promise<any>;
    static deployed(web3: Web3, defaults: Tx): Promise<OracleProxyContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<OracleProxyContract>;

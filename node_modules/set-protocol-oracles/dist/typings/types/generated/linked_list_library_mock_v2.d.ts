...
export declare class LinkedListLibraryMockV2Contract extends BaseContract {
    initializeMock: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<LinkedListLibraryMockV2Contract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<LinkedListLibraryMockV2Contract>;

...
export declare class DSAuthContract extends BaseContract {
    owner: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<DSAuthContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<DSAuthContract>;

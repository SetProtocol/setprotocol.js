...
export declare class USDCMockContract extends BaseContract {
    name: {
    ...
    static deployed(web3: Web3, defaults: Tx): Promise<USDCMockContract>;
    static at(address: string, web3: Web3, defaults: Tx): Promise<USDCMockContract>;

...
var LinearizedPriceDataSource_1 = require("../../artifacts/ts/LinearizedPriceDataSource");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var LinearizedPriceDataSourceContract = /** @class */ (function (_super) {
    __extends(LinearizedPriceDataSourceContract, _super);
    function LinearizedPriceDataSourceContract(web3ContractInstance, defaults) {
        ...
        _this.read = {
            callAsync: function (_timeSeriesState, defaultBlock) {
                return __awaiter(this, void 0, void 0, function () {
                    var self, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.read(this.formatABIDataItem('tuple', [
                                        {
                                            name: 'nextEarliestUpdate',
                                            type: 'uint256',
                                    ...
                                    ], _timeSeriesState)).call, self.web3ContractInstance)()];
                            case 1:
                                result = _a.sent();
                                return [2 /*return*/, new set_protocol_utils_1.BigNumber(result)];
                        }
    ...
    LinearizedPriceDataSourceContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    LinearizedPriceDataSourceContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = LinearizedPriceDataSource_1.LinearizedPriceDataSource.abi, networks = LinearizedPriceDataSource_1.LinearizedPriceDataSource.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new LinearizedPriceDataSourceContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    LinearizedPriceDataSourceContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = LinearizedPriceDataSource_1.LinearizedPriceDataSource.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('LinearizedPriceDataSource', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return LinearizedPriceDataSourceContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.LinearizedPriceDataSourceContract = LinearizedPriceDataSourceContract;

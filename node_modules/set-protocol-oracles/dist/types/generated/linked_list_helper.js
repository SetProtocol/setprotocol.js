...
var LinkedListHelper_1 = require("../../artifacts/ts/LinkedListHelper");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var LinkedListHelperContract = /** @class */ (function (_super) {
    __extends(LinkedListHelperContract, _super);
    function LinkedListHelperContract(web3ContractInstance, defaults) {
    ...
    LinkedListHelperContract.prototype.deploy = function (data, args) {
    ...
    LinkedListHelperContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = LinkedListHelper_1.LinkedListHelper.abi, networks = LinkedListHelper_1.LinkedListHelper.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new LinkedListHelperContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    LinkedListHelperContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = LinkedListHelper_1.LinkedListHelper.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('LinkedListHelper', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return LinkedListHelperContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.LinkedListHelperContract = LinkedListHelperContract;

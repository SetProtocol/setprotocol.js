...
var RSILibrary_1 = require("../../artifacts/ts/RSILibrary");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var RSILibraryContract = /** @class */ (function (_super) {
    __extends(RSILibraryContract, _super);
    function RSILibraryContract(web3ContractInstance, defaults) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.HUNDRED().call, self.web3ContractInstance)()];
                            case 1:
                                result = _a.sent();
    ...
    RSILibraryContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    RSILibraryContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = RSILibrary_1.RSILibrary.abi, networks = RSILibrary_1.RSILibrary.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new RSILibraryContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    RSILibraryContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = RSILibrary_1.RSILibrary.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('RSILibrary', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return RSILibraryContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.RSILibraryContract = RSILibraryContract;

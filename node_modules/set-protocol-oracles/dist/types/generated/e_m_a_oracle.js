...
var EMAOracle_1 = require("../../artifacts/ts/EMAOracle");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var EMAOracleContract = /** @class */ (function (_super) {
    __extends(EMAOracleContract, _super);
    function EMAOracleContract(web3ContractInstance, defaults) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.emaTimeSeriesFeeds(this.formatABIDataItem('uint256', [], index_0)).call, self.web3ContractInstance)()];
                            case 1:
                                result = _a.sent();
        ...
        _this.read = {
            callAsync: function (_emaTimePeriod, defaultBlock) {
                return __awaiter(this, void 0, void 0, function () {
                    var self, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.read(this.formatABIDataItem('uint256', [], _emaTimePeriod)).call, self.web3ContractInstance)()];
                            case 1:
                                result = _a.sent();
                                return [2 /*return*/, new set_protocol_utils_1.BigNumber(result)];
                        }
        ...
        _this.addFeed = {
            sendTransactionAsync: function (_feedAddress, _emaTimePeriod, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, self.applyDefaultsToTxDataAsync(txData, self.addFeed.estimateGasAsync.bind(self, this.formatABIDataItem('address', [], _feedAddress), this.formatABIDataItem('uint256', [], _emaTimePeriod)))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.addFeed(this.formatABIDataItem('address', [], _feedAddress), this.formatABIDataItem('uint256', [], _emaTimePeriod)).send, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            estimateGasAsync: function (_feedAddress, _emaTimePeriod, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, gas;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.addFeed(this.formatABIDataItem('address', [], _feedAddress), this.formatABIDataItem('uint256', [], _emaTimePeriod)).estimateGas, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
            ...
            getABIEncodedTransactionData: function (_feedAddress, _emaTimePeriod, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.methods.addFeed(this.formatABIDataItem('address', [], _feedAddress), this.formatABIDataItem('uint256', [], _emaTimePeriod)).encodeABI();
                return abiEncodedTransactionData;
            },
            callAsync: function (_feedAddress, _emaTimePeriod, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.addFeed(this.formatABIDataItem('address', [], _feedAddress), this.formatABIDataItem('uint256', [], _emaTimePeriod)).call, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                result = _a.sent();
                                return [2 /*return*/, result];
                        }
        ...
        _this.removeFeed = {
            sendTransactionAsync: function (_emaTimePeriod, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, self.applyDefaultsToTxDataAsync(txData, self.removeFeed.estimateGasAsync.bind(self, this.formatABIDataItem('uint256', [], _emaTimePeriod)))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.removeFeed(this.formatABIDataItem('uint256', [], _emaTimePeriod)).send, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            estimateGasAsync: function (_emaTimePeriod, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, gas;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.removeFeed(this.formatABIDataItem('uint256', [], _emaTimePeriod)).estimateGas, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
            ...
            getABIEncodedTransactionData: function (_emaTimePeriod, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.methods.removeFeed(this.formatABIDataItem('uint256', [], _emaTimePeriod)).encodeABI();
                return abiEncodedTransactionData;
            },
            callAsync: function (_emaTimePeriod, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.removeFeed(this.formatABIDataItem('uint256', [], _emaTimePeriod)).call, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                result = _a.sent();
                                return [2 /*return*/, result];
                        }
    ...
    EMAOracleContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    EMAOracleContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = EMAOracle_1.EMAOracle.abi, networks = EMAOracle_1.EMAOracle.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new EMAOracleContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    EMAOracleContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = EMAOracle_1.EMAOracle.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('EMAOracle', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return EMAOracleContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.EMAOracleContract = EMAOracleContract;

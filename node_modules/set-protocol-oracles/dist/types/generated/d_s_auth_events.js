...
var DSAuthEvents_1 = require("../../artifacts/ts/DSAuthEvents");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var DSAuthEventsContract = /** @class */ (function (_super) {
    __extends(DSAuthEventsContract, _super);
    function DSAuthEventsContract(web3ContractInstance, defaults) {
    ...
    DSAuthEventsContract.prototype.deploy = function (data, args) {
    ...
    DSAuthEventsContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = DSAuthEvents_1.DSAuthEvents.abi, networks = DSAuthEvents_1.DSAuthEvents.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new DSAuthEventsContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    DSAuthEventsContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = DSAuthEvents_1.DSAuthEvents.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('DSAuthEvents', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return DSAuthEventsContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.DSAuthEventsContract = DSAuthEventsContract;

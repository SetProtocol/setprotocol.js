...
var IMedian_1 = require("../../artifacts/ts/IMedian");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var IMedianContract = /** @class */ (function (_super) {
    __extends(IMedianContract, _super);
    function IMedianContract(web3ContractInstance, defaults) {
    ...
    IMedianContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    IMedianContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = IMedian_1.IMedian.abi, networks = IMedian_1.IMedian.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new IMedianContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    IMedianContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = IMedian_1.IMedian.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('IMedian', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return IMedianContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.IMedianContract = IMedianContract;

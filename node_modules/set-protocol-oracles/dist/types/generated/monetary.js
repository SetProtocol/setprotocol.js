...
var Monetary_1 = require("../../artifacts/ts/Monetary");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var MonetaryContract = /** @class */ (function (_super) {
    __extends(MonetaryContract, _super);
    function MonetaryContract(web3ContractInstance, defaults) {
    ...
    MonetaryContract.prototype.deploy = function (data, args) {
    ...
    MonetaryContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = Monetary_1.Monetary.abi, networks = Monetary_1.Monetary.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new MonetaryContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    MonetaryContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = Monetary_1.Monetary.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('Monetary', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return MonetaryContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.MonetaryContract = MonetaryContract;

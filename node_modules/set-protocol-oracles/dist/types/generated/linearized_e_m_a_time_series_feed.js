...
var LinearizedEMATimeSeriesFeed_1 = require("../../artifacts/ts/LinearizedEMATimeSeriesFeed");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var LinearizedEMATimeSeriesFeedContract = /** @class */ (function (_super) {
    __extends(LinearizedEMATimeSeriesFeedContract, _super);
    function LinearizedEMATimeSeriesFeedContract(web3ContractInstance, defaults) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.emaTimePeriod().call, self.web3ContractInstance)()];
                            case 1:
                                result = _a.sent();
                                return [2 /*return*/, new set_protocol_utils_1.BigNumber(result)];
                        }
        ...
        _this.changeOracle = {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, self.applyDefaultsToTxDataAsync(txData, self.changeOracle.estimateGasAsync.bind(self, this.formatABIDataItem('address', [], _newOracleAddress)))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.changeOracle(this.formatABIDataItem('address', [], _newOracleAddress)).send, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.changeOracle(this.formatABIDataItem('address', [], _newOracleAddress)).estimateGas, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
            ...
            getABIEncodedTransactionData: function (_newOracleAddress, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.methods.changeOracle(this.formatABIDataItem('address', [], _newOracleAddress)).encodeABI();
                return abiEncodedTransactionData;
            },
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.methods.changeOracle(this.formatABIDataItem('address', [], _newOracleAddress)).call, self.web3ContractInstance)(txDataWithDefaults)];
                            case 2:
                                result = _a.sent();
                                return [2 /*return*/, result];
                        }
    ...
    LinearizedEMATimeSeriesFeedContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    LinearizedEMATimeSeriesFeedContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = LinearizedEMATimeSeriesFeed_1.LinearizedEMATimeSeriesFeed.abi, networks = LinearizedEMATimeSeriesFeed_1.LinearizedEMATimeSeriesFeed.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new LinearizedEMATimeSeriesFeedContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    LinearizedEMATimeSeriesFeedContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = LinearizedEMATimeSeriesFeed_1.LinearizedEMATimeSeriesFeed.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('LinearizedEMATimeSeriesFeed', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return LinearizedEMATimeSeriesFeedContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.LinearizedEMATimeSeriesFeedContract = LinearizedEMATimeSeriesFeedContract;
